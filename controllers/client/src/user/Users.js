...
showlist=()=>(<div className="row">    
  ...
  <img className="card-img-top" src={`${process.env.REACT_APP_API_URL}/user/photo/${user._id}`}  alt="Card image cap" style={{width:'100%',height:'15vw',objectFit:'cover'}} />
...
<h2 className="mt-5 mb-5">Userss</h2>
{this.showlist()}
</div>
